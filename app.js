...
app.post("/majorproject",function(req,res){
  var projects;
  mongoose.Promise=global.Promise;
  ...
  if(req.body.userInput){
    ...
    Major.find({$or:[{projectName:{$regex : new RegExp(key, "i")}},{guide:{$regex : new RegExp(key,"i")}}]},function(err ,found){
      ...
      res.render("projects/majorproject",{projects : found ,searched:key});
      });
  }
    ...
    Major.find(function(err ,found){
      //     console.log(found);
       console.log(found);
       res.render("projects/majorproject",{projects : found ,searched:req.body.domain});
     });
  }   
  else{
...
app.get("/majorproject",(req,res)=>{
  res.render("projects/majorproject");
});
